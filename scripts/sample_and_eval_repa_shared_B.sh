#!/bin/bash
#
# Sample from ProMoE-TC-REPA-Shared-B at step 300K, then evaluate FID.
#
...
#
# Prerequisites:
#   - Training checkpoint at outputs/ProMoE_TC_REPA_Shared_B/004_ProMoE_B_repa_shared/checkpoints/ckpt_step_300000.pth
...
SAMPLE_ROOT="${PROJECT_ROOT}/outputs/ProMoE_TC_REPA_Shared_B/004_ProMoE_B_repa_shared/sample/step${SAMPLE_STEP}"
