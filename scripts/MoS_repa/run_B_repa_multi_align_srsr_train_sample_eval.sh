#!/bin/bash
#
# Train the proposed shared/routed spectral-responsibility Multi-Align arm,
...
CONFIG="configs/004_ProMoE_B_repa_multi_align_srsr.yaml"
LOG="log_ProMoE_B_repa_multi_align_srsr_train_sample_eval.log"
