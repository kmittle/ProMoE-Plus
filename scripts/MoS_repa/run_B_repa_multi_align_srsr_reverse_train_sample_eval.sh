#!/bin/bash
#
# Train the reversed shared/routed spectral-responsibility control,
# then sample and evaluate each requested checkpoint.
#
...
CONFIG="configs/004_ProMoE_B_repa_multi_align_srsr_reverse.yaml"
LOG="log_ProMoE_B_repa_multi_align_srsr_reverse_train_sample_eval.log"
