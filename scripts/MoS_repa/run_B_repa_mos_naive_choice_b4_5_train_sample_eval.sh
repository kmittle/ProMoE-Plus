#!/bin/bash
#
# Train ProMoE-TC-REPA-MoS-Naive-Choice-B (align blocks 4-5), then sample and evaluate FID.
#
# Ablation: only align DiT blocks 3-4 with MoS REPA to test whether
# shifting the smallest window one block later changes the gain around layer 4.
#
# Step 1: Train with configs/004_ProMoE_B_repa_MoS_naive_choice_b4_5.yaml
...
CONFIG="configs/004_ProMoE_B_repa_MoS_naive_choice_b4_5.yaml"
LOG="log_ProMoE_B_repa_MoS_naive_choice_b4_5_train_sample_eval.log"
