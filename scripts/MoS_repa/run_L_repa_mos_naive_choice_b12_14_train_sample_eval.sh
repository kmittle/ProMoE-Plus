#!/bin/bash
#
# Ablation: MoS Naive Choice L, align blocks 12-14 (indices 11-13).
...
CONFIG="configs/004_ProMoE_L_repa_MoS_naive_choice_b12_14.yaml"
LOG="log_ProMoE_L_repa_MoS_naive_choice_b12_14_train_sample_eval.log"
