#!/bin/bash
#
# Ablation: BlockRouter input LayerNorm -> RMSNorm (align blocks 3-5).
# Only the two input norms (x_norm, c_norm) in BlockRouter are changed;
# RouterTransformerBlock internal LayerNorms are kept as-is.
#
# Prerequisites:
...
CONFIG="configs/004_ProMoE_B_repa_MoS_naive_choice_b3_5_rmsnorm.yaml"
LOG="log_ProMoE_B_repa_MoS_naive_choice_b3_5_rmsnorm_train_sample_eval.log"
