#!/bin/bash
#
# Ablation: Multi-Align without sigmoid dynamic weighting (uniform coeff).
# Tests multi-block REPA alignment with teacher last layer only,
# removing the AlignCoefficientPredictor to isolate its contribution.
#
# Prerequisites:
...
CONFIG="configs/004_ProMoE_B_repa_multi_align_no_dynamic.yaml"
LOG="log_ProMoE_B_repa_multi_align_no_dynamic_train_sample_eval.log"
