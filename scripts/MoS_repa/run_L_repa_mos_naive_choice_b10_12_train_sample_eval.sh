#!/bin/bash
#
# Ablation: MoS Naive Choice L, align blocks 10-12 (indices 9-11).
...
CONFIG="configs/004_ProMoE_L_repa_MoS_naive_choice_b10_12.yaml"
LOG="log_ProMoE_L_repa_MoS_naive_choice_b10_12_train_sample_eval.log"
