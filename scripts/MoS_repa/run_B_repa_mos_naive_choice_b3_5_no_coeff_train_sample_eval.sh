#!/bin/bash
#
# Train ProMoE-TC-REPA-MoS-Naive-Choice-B (align blocks 3-5, no proj_coeff scaling),
# then sample and evaluate FID.
#
# Ablation: proj_coeff = 1.0 instead of 0.5, removing the outer REPA loss scaling.
# All other hyperparameters identical to 004_ProMoE_B_repa_MoS_naive_choice_b3_5.yaml.
#
# Step 1: Train with configs/004_ProMoE_B_repa_MoS_naive_choice_b3_5_no_coeff.yaml
...
CONFIG="configs/004_ProMoE_B_repa_MoS_naive_choice_b3_5_no_coeff.yaml"
LOG="log_ProMoE_B_repa_MoS_naive_choice_b3_5_no_coeff_train_sample_eval.log"
