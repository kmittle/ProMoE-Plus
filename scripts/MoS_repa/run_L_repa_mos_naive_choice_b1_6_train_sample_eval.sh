#!/bin/bash
#
# Ablation: MoS Naive Choice L, align blocks 1-6 (indices 0-5).
...
CONFIG="configs/004_ProMoE_L_repa_MoS_naive_choice_b1_6.yaml"
LOG="log_ProMoE_L_repa_MoS_naive_choice_b1_6_train_sample_eval.log"
