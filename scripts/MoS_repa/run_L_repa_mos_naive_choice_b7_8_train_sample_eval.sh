#!/bin/bash
#
# Ablation: MoS Naive Choice L, align blocks 7-8 (indices 6-7).
...
CONFIG="configs/004_ProMoE_L_repa_MoS_naive_choice_b7_8.yaml"
LOG="log_ProMoE_L_repa_MoS_naive_choice_b7_8_train_sample_eval.log"
