#!/bin/bash
#
# Ablation: MoS Naive Choice L, align blocks 9-11 (indices 8-10).
...
CONFIG="configs/004_ProMoE_L_repa_MoS_naive_choice_b9_11.yaml"
LOG="log_ProMoE_L_repa_MoS_naive_choice_b9_11_train_sample_eval.log"
