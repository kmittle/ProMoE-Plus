#!/bin/bash
#
# Train ProMoE-TC-REPA-MoS-Naive-Choice-XL (align blocks 7-9), then sample and evaluate FID.
#
# Step 1: Train with configs/004_ProMoE_XL_repa_MoS_naive_choice_b7_9.yaml
...
CONFIG="configs/004_ProMoE_XL_repa_MoS_naive_choice_b7_9.yaml"
LOG="log_ProMoE_XL_repa_MoS_naive_choice_b7_9_train_sample_eval.log"
