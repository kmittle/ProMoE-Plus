#!/bin/bash
#
# Ablation: MoS Naive Choice L, align blocks 5-7 (indices 4-6).
...
CONFIG="configs/004_ProMoE_L_repa_MoS_naive_choice_b5_7.yaml"
LOG="log_ProMoE_L_repa_MoS_naive_choice_b5_7_train_sample_eval.log"
