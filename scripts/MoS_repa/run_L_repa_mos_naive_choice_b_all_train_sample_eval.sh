#!/bin/bash
#
# Ablation: MoS Naive Choice L, all 24 blocks participate in alignment.
# Baseline comparison against selective block alignment variants.
#
# Prerequisites:
...
CONFIG="configs/004_ProMoE_L_repa_MoS_naive_choice_b_all.yaml"
LOG="log_ProMoE_L_repa_MoS_naive_choice_b_all_train_sample_eval.log"
