#!/bin/bash
#
# Train ProMoE-TC-REPA-MoS-Naive-Choice-B (align blocks 3-6), then sample and evaluate FID.
#
# Ablation: only align DiT blocks 2-5 with MoS REPA to test whether
# a 4-layer window centered around layer 4 is the most effective region.
#
# Step 1: Train with configs/004_ProMoE_B_repa_MoS_naive_choice_b3_6.yaml
...
CONFIG="configs/004_ProMoE_B_repa_MoS_naive_choice_b3_6.yaml"
LOG="log_ProMoE_B_repa_MoS_naive_choice_b3_6_train_sample_eval.log"
