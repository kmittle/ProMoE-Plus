#!/bin/bash
#
# Train ProMoE-TC-REPA-MoS-Naive-Choice-B (align blocks 2-4), then sample and evaluate FID.
#
# Ablation: only align DiT blocks 1-3 with MoS REPA to test whether
# a 3-layer window ending at layer 4 captures the main improvement.
#
# Step 1: Train with configs/004_ProMoE_B_repa_MoS_naive_choice_b2_4.yaml
...
CONFIG="configs/004_ProMoE_B_repa_MoS_naive_choice_b2_4.yaml"
LOG="log_ProMoE_B_repa_MoS_naive_choice_b2_4_train_sample_eval.log"
