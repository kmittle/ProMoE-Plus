#!/bin/bash
#
# Train ProMoE-TC-REPA-MoS-Naive-Choice-B (align blocks 3-5), then sample and evaluate FID.
#
# Ablation: only align DiT blocks 2-4 with MoS REPA to test whether
# centering a 3-layer window on layer 4 gives the best trade-off.
#
# Step 1: Train with configs/004_ProMoE_B_repa_MoS_naive_choice_b3_5.yaml
...
CONFIG="configs/004_ProMoE_B_repa_MoS_naive_choice_b3_5.yaml"
LOG="log_ProMoE_B_repa_MoS_naive_choice_b3_5_train_sample_eval.log"
