#!/bin/bash
#
# Train ProMoE-TC-REPA-MoS-Naive-Choice-B (align blocks 3-5, proj_coeff=1.5),
# then sample and evaluate FID.
#
# Ablation: proj_coeff=1.5 (baseline: 0.5)
#
...
CONFIG="configs/004_ProMoE_B_repa_MoS_naive_choice_b3_5_coeff150.yaml"
LOG="log_ProMoE_B_repa_MoS_naive_choice_b3_5_coeff150_train_sample_eval.log"
