#!/bin/bash
#
# Ablation: MoS Naive Choice L, align blocks 6-7 (indices 5-6).
...
CONFIG="configs/004_ProMoE_L_repa_MoS_naive_choice_b6_7.yaml"
LOG="log_ProMoE_L_repa_MoS_naive_choice_b6_7_train_sample_eval.log"
