#!/bin/bash
#
# Ablation: MoS Naive Choice L, align blocks 11-13 (indices 10-12).
...
CONFIG="configs/004_ProMoE_L_repa_MoS_naive_choice_b11_13.yaml"
LOG="log_ProMoE_L_repa_MoS_naive_choice_b11_13_train_sample_eval.log"
