#!/bin/bash
#
# Ablation: MoS Naive Choice L, align blocks 19-24 (indices 18-23).
# Coarse-grained sweep to locate best alignment range for DiT-L.
#
# Prerequisites:
...
CONFIG="configs/004_ProMoE_L_repa_MoS_naive_choice_b19_24.yaml"
LOG="log_ProMoE_L_repa_MoS_naive_choice_b19_24_train_sample_eval.log"
