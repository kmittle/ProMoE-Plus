#!/bin/bash
#
# Train ProMoE-TC-REPA-MoS-Naive-Choice-L (align blocks 7-9), then sample and evaluate FID.
#
# Step 1: Train with configs/004_ProMoE_L_repa_MoS_naive_choice_b7_9.yaml
...
CONFIG="configs/004_ProMoE_L_repa_MoS_naive_choice_b7_9.yaml"
LOG="log_ProMoE_L_repa_MoS_naive_choice_b7_9_train_sample_eval.log"
