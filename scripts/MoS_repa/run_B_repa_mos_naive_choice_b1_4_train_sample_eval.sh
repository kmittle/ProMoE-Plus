#!/bin/bash
#
# Train ProMoE-TC-REPA-MoS-Naive-Choice-B (align blocks 1-4), then sample and evaluate FID.
#
# Ablation: only align DiT blocks 0-3 with MoS REPA to test whether
# early-layer alignment is sufficient compared to aligning all blocks.
#
# Step 1: Train with configs/004_ProMoE_B_repa_MoS_naive_choice_b1_4.yaml
...
CONFIG="configs/004_ProMoE_B_repa_MoS_naive_choice_b1_4.yaml"
LOG="log_ProMoE_B_repa_MoS_naive_choice_b1_4_train_sample_eval.log"
