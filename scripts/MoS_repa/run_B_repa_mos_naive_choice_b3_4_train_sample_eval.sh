#!/bin/bash
#
# Train ProMoE-TC-REPA-MoS-Naive-Choice-B (align blocks 3-4), then sample and evaluate FID.
#
# Ablation: only align DiT blocks 2-3 with MoS REPA to test whether
# the smallest sliding window that still includes layer 4 is sufficient.
#
# Step 1: Train with configs/004_ProMoE_B_repa_MoS_naive_choice_b3_4.yaml
...
CONFIG="configs/004_ProMoE_B_repa_MoS_naive_choice_b3_4.yaml"
LOG="log_ProMoE_B_repa_MoS_naive_choice_b3_4_train_sample_eval.log"
