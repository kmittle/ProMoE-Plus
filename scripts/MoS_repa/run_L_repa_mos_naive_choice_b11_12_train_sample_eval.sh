#!/bin/bash
#
# Ablation: MoS Naive Choice L, align blocks 11-12 (indices 10-11).
...
CONFIG="configs/004_ProMoE_L_repa_MoS_naive_choice_b11_12.yaml"
LOG="log_ProMoE_L_repa_MoS_naive_choice_b11_12_train_sample_eval.log"
