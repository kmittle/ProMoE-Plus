#!/bin/bash
#
# Ablation: MoS Naive Choice L, align blocks 8-9 (indices 7-8).
...
CONFIG="configs/004_ProMoE_L_repa_MoS_naive_choice_b8_9.yaml"
LOG="log_ProMoE_L_repa_MoS_naive_choice_b8_9_train_sample_eval.log"
