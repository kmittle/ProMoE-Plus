#!/bin/bash
#
# Train ProMoE-TC-REPA-Multi-Align-B, then sample and evaluate FID.
#
# Multi-point REPA: DiT blocks 3-5 all align with DINOv2 last layer,
# with a transformer-based AlignCoefficientPredictor producing per-token
# sigmoid alignment coefficients.
#
# Step 1: Train with configs/004_ProMoE_B_repa_multi_align.yaml
...
CONFIG="configs/004_ProMoE_B_repa_multi_align.yaml"
LOG="log_ProMoE_B_repa_multi_align_train_sample_eval.log"
