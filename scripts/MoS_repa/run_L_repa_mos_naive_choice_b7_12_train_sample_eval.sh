#!/bin/bash
#
# Ablation: MoS Naive Choice L, align blocks 7-12 (indices 6-11).
...
CONFIG="configs/004_ProMoE_L_repa_MoS_naive_choice_b7_12.yaml"
LOG="log_ProMoE_L_repa_MoS_naive_choice_b7_12_train_sample_eval.log"
