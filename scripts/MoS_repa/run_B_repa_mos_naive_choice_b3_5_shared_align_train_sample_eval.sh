#!/bin/bash
#
# Ablation: align at shared expert output instead of block output (blocks 3-5).
# MoE blocks use shared expert output; dense blocks fall back to block output.
#
# Prerequisites:
...
CONFIG="configs/004_ProMoE_B_repa_MoS_naive_choice_b3_5_shared_align.yaml"
LOG="log_ProMoE_B_repa_MoS_naive_choice_b3_5_shared_align_train_sample_eval.log"
