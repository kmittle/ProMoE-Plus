#!/bin/bash
#
# Train ProMoE-TC-REPA-MoS-Naive-Choice-Sep-B (align blocks 3-5), then sample and evaluate FID.
#
# Variant: BlockRouter uses separate t_embed and y_embed projections (with RMSNorm)
# instead of combined c = t + y conditioning, testing whether disentangled conditioning
# tokens improve the router's block selection quality.
#
# Step 1: Train with configs/004_ProMoE_B_repa_MoS_naive_choice_sep_b3_5.yaml
...
CONFIG="configs/004_ProMoE_B_repa_MoS_naive_choice_sep_b3_5.yaml"
LOG="log_ProMoE_B_repa_MoS_naive_choice_sep_b3_5_train_sample_eval.log"
