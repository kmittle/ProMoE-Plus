#!/bin/bash
#
# Ablation: MoS Naive Choice L, align blocks 8-10 (indices 7-9).
...
CONFIG="configs/004_ProMoE_L_repa_MoS_naive_choice_b8_10.yaml"
LOG="log_ProMoE_L_repa_MoS_naive_choice_b8_10_train_sample_eval.log"
