#!/bin/bash
#
# Train ProMoE-TC-REPA-MoS-Naive-Choice-B (align blocks 9-12), then sample and evaluate FID.
#
# Ablation: only align DiT blocks 8-11 with MoS REPA to test whether
# late-layer alignment is sufficient compared to aligning all blocks.
#
# Step 1: Train with configs/004_ProMoE_B_repa_MoS_naive_choice_b9_12.yaml
...
CONFIG="configs/004_ProMoE_B_repa_MoS_naive_choice_b9_12.yaml"
LOG="log_ProMoE_B_repa_MoS_naive_choice_b9_12_train_sample_eval.log"
