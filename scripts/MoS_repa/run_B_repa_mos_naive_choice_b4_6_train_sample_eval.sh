#!/bin/bash
#
# Train ProMoE-TC-REPA-MoS-Naive-Choice-B (align blocks 4-6), then sample and evaluate FID.
#
# Ablation: only align DiT blocks 3-5 with MoS REPA to test whether
# a 3-layer window starting at layer 4 is the strongest local region.
#
# Step 1: Train with configs/004_ProMoE_B_repa_MoS_naive_choice_b4_6.yaml
...
CONFIG="configs/004_ProMoE_B_repa_MoS_naive_choice_b4_6.yaml"
LOG="log_ProMoE_B_repa_MoS_naive_choice_b4_6_train_sample_eval.log"
