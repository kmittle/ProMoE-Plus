#!/bin/bash
#
# Ablation: Fused MoS REPA alignment (b3_5 baseline).
# Fuses top-k teacher blocks via routing weights before alignment,
# with a shared Transformer+sigmoid CoeffPredictor for loss weighting.
#
# Prerequisites:
...
CONFIG="configs/004_ProMoE_B_repa_MoS_naive_choice_b3_5_fused.yaml"
LOG="log_ProMoE_B_repa_MoS_naive_choice_b3_5_fused_train_sample_eval.log"
