#!/bin/bash
#
# Ablation: MoS Naive Choice L, align blocks 13-18 (indices 12-17).
...
CONFIG="configs/004_ProMoE_L_repa_MoS_naive_choice_b13_18.yaml"
LOG="log_ProMoE_L_repa_MoS_naive_choice_b13_18_train_sample_eval.log"
