#!/bin/bash
#
# Train ProMoE-TC-REPA-MoS-Naive-Choice-B (align blocks 3-5, proj_coeff=0.75),
# then sample and evaluate FID.
#
# Ablation: proj_coeff=0.75 (baseline: 0.5)
#
...
CONFIG="configs/004_ProMoE_B_repa_MoS_naive_choice_b3_5_coeff075.yaml"
LOG="log_ProMoE_B_repa_MoS_naive_choice_b3_5_coeff075_train_sample_eval.log"
