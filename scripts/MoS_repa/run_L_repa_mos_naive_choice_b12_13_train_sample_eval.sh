#!/bin/bash
#
# Ablation: MoS Naive Choice L, align blocks 12-13 (indices 11-12).
...
CONFIG="configs/004_ProMoE_L_repa_MoS_naive_choice_b12_13.yaml"
LOG="log_ProMoE_L_repa_MoS_naive_choice_b12_13_train_sample_eval.log"
