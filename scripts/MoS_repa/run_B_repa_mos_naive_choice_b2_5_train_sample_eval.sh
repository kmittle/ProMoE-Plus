#!/bin/bash
#
# Train ProMoE-TC-REPA-MoS-Naive-Choice-B (align blocks 2-5), then sample and evaluate FID.
#
# Ablation: only align DiT blocks 1-4 with MoS REPA to test whether
# the best 4-layer region starts one block earlier than the known 1-4 setup.
#
# Step 1: Train with configs/004_ProMoE_B_repa_MoS_naive_choice_b2_5.yaml
...
CONFIG="configs/004_ProMoE_B_repa_MoS_naive_choice_b2_5.yaml"
LOG="log_ProMoE_B_repa_MoS_naive_choice_b2_5_train_sample_eval.log"
