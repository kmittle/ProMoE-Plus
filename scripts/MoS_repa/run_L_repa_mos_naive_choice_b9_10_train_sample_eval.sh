#!/bin/bash
#
# Ablation: MoS Naive Choice L, align blocks 9-10 (indices 8-9).
...
CONFIG="configs/004_ProMoE_L_repa_MoS_naive_choice_b9_10.yaml"
LOG="log_ProMoE_L_repa_MoS_naive_choice_b9_10_train_sample_eval.log"
