#!/bin/bash
#
# Train ProMoE-TC-REPA-MoS-Naive-B, then sample and evaluate FID.
#
# Step 1: Train with configs/004_ProMoE_B_repa_MoS_naive.yaml
...
CONFIG="configs/004_ProMoE_B_repa_MoS_naive.yaml"
LOG="log_ProMoE_B_repa_MoS_naive_train_sample_eval.log"
