#!/bin/bash
#
# Train ProMoE-TC-REPA-MoS-Naive-Choice-B (align blocks 4-7), then sample and evaluate FID.
#
# Ablation: only align DiT blocks 3-6 with MoS REPA to test whether
# the best 4-layer region starts exactly from layer 4.
#
# Step 1: Train with configs/004_ProMoE_B_repa_MoS_naive_choice_b4_7.yaml
...
CONFIG="configs/004_ProMoE_B_repa_MoS_naive_choice_b4_7.yaml"
LOG="log_ProMoE_B_repa_MoS_naive_choice_b4_7_train_sample_eval.log"
