#!/bin/bash
#
# Train ProMoE-TC-REPA-MoS-B, then sample and evaluate FID.
#
# Step 1: Train with configs/004_ProMoE_B_repa_MoS.yaml
...
LOG="log_ProMoE_B_repa_MoS_train_sample_eval.log"
