#!/bin/bash
#
# Train ProMoE-TC-REPA-MoS-Naive-Choice-B (align blocks 5-8), then sample and evaluate FID.
#
# Ablation: only align DiT blocks 4-7 with MoS REPA to test whether
# middle-layer alignment is sufficient compared to aligning all blocks.
#
# Step 1: Train with configs/004_ProMoE_B_repa_MoS_naive_choice_b5_8.yaml
...
CONFIG="configs/004_ProMoE_B_repa_MoS_naive_choice_b5_8.yaml"
LOG="log_ProMoE_B_repa_MoS_naive_choice_b5_8_train_sample_eval.log"
