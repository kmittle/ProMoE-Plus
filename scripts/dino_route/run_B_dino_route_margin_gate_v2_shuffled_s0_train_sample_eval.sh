...
CONFIG="configs/004_ProMoE_B_dino_route_margin_gate_v2_shuffled_s0.yaml"
LOG="$REPO_ROOT/logs/log_ProMoE_B_dino_route_margin_gate_v2_shuffled_s0_train_sample_eval.log"
mkdir -p "$(dirname "$LOG")"
