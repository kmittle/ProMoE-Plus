#!/bin/bash
#
# ProMoE-TC-B heterogeneous expert + output/parameter separation arm (HOP).
# This arm is the no-LS-Reg control for the full expert-separation pair.
#
...
CONFIG="configs/004_ProMoE_B_capacity_combo_HOP.yaml"
LOG="${REPO_ROOT}/logs/log_ProMoE_B_capacity_combo_HOP_train_sample_eval.log"
mkdir -p "$(dirname "$LOG")"
