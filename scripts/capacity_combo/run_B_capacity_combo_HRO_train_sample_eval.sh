#!/bin/bash
#
# ProMoE-TC-B capacity-aware expert responsibility ablation (HRO).
...
CONFIG="configs/004_ProMoE_B_capacity_combo_HRO.yaml"
LOG="${REPO_ROOT}/logs/log_ProMoE_B_capacity_combo_HRO_train_sample_eval.log"
mkdir -p "$(dirname "$LOG")"
