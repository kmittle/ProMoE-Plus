#!/bin/bash
#
# ProMoE-TC-B capacity-aware expert responsibility ablation (HP).
...
CONFIG="configs/004_ProMoE_B_capacity_combo_HP.yaml"
LOG="${REPO_ROOT}/logs/log_ProMoE_B_capacity_combo_HP_train_sample_eval.log"
mkdir -p "$(dirname "$LOG")"
