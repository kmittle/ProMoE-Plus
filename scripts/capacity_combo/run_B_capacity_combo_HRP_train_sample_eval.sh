#!/bin/bash
#
# ProMoE-TC-B capacity-aware expert responsibility ablation (HRP).
...
CONFIG="configs/004_ProMoE_B_capacity_combo_HRP.yaml"
LOG="${REPO_ROOT}/logs/log_ProMoE_B_capacity_combo_HRP_train_sample_eval.log"
mkdir -p "$(dirname "$LOG")"
