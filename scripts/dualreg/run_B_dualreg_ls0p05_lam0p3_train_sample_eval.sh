...
# lam=0.3.  One arm of a 2x4 grid (LS-Reg on/off x four lam values).  Trains
...
CONFIG="configs/004_ProMoE_B_dualreg_ls0p05_lam0p3.yaml"
LOG="${REPO_ROOT}/logs/log_ProMoE_B_dualreg_ls0p05_lam0p3_train_sample_eval.log"
mkdir -p "$(dirname "$LOG")"
