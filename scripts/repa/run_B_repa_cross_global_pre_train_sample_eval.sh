#!/bin/bash
#
# Train ProMoE-TC-REPA-CROSS-GLOBAL-PRE-B, then sample and evaluate FID.
#
# Experiment 1: Naive REPA + Global Pre-Block Attention cross-alignment.
# Uses a 2-layer transformer after patchify to compute a global attention map,
# then cross-aligns tokens within the same expert group at encoder_depth.
#
# Step 1: Train with configs/004_ProMoE_B_repa_cross_global_pre.yaml
...
CONFIG="configs/004_ProMoE_B_repa_cross_global_pre.yaml"
LOG="log_ProMoE_B_repa_cross_global_pre_train_sample_eval.log"
