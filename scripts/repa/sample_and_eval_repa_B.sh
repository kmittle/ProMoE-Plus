#!/bin/bash
#
# Sample from ProMoE-TC-REPA-B at step 300K & 500K, then evaluate FID.
#
...
#
# Prerequisites:
#   - Training checkpoints at outputs/ProMoE_TC_REPA_B/004_ProMoE_B_repa/checkpoints/
...
for step in 300000 500000; do
    SAMPLE_ROOT="${PROJECT_ROOT}/outputs/ProMoE_TC_REPA_B/004_ProMoE_B_repa/sample/step${step}"
