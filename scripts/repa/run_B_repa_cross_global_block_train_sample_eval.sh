#!/bin/bash
#
# Train ProMoE-TC-REPA-CROSS-GLOBAL-BLOCK-B, then sample and evaluate FID.
#
# Experiment 2: Naive REPA + Per-Block Attention cross-alignment.
# Uses a 2-layer transformer at the alignment block output to compute an
# attention map, then cross-aligns tokens within the same expert group.
#
# Step 1: Train with configs/004_ProMoE_B_repa_cross_global_block.yaml
...
CONFIG="configs/004_ProMoE_B_repa_cross_global_block.yaml"
LOG="log_ProMoE_B_repa_cross_global_block_train_sample_eval.log"
