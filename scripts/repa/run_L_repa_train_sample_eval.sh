#!/bin/bash
#
# Train ProMoE-TC-REPA-L (naive REPA, encoder_depth=8), then sample and evaluate FID.
#
# Step 1: Train with configs/004_ProMoE_L_repa.yaml
...
CONFIG="configs/004_ProMoE_L_repa.yaml"
LOG="log_ProMoE_L_repa_train_sample_eval.log"
