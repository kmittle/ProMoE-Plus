#!/bin/bash
#
# Train ProMoE-TC-REPA-CROSS-EXPERT-LOCAL-B, then sample and evaluate FID.
#
# Experiment 3: Naive REPA + Expert-Local Attention cross-alignment.
# Uses a 2-layer transformer at the alignment block output with masked attention
# that only considers tokens within the same conditional expert group.
#
# Step 1: Train with configs/004_ProMoE_B_repa_cross_expert_local.yaml
...
CONFIG="configs/004_ProMoE_B_repa_cross_expert_local.yaml"
LOG="log_ProMoE_B_repa_cross_expert_local_train_sample_eval.log"
