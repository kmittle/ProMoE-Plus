#!/bin/bash
#
# Train ProMoE-TC-REPA-Routed-B, then sample and evaluate FID.
#
# Step 1: Train with configs/004_ProMoE_B_repa_routed.yaml
...
CONFIG="configs/004_ProMoE_B_repa_routed.yaml"
LOG="log_ProMoE_B_repa_routed_train_sample_eval.log"
