#!/bin/bash
#
# Train ProMoE-TC-REPA-Double-Share-B, then sample and evaluate FID.
#
# Step 1: Train with configs/004_ProMoE_B_repa_double_share.yaml
...
CONFIG="configs/004_ProMoE_B_repa_double_share.yaml"
LOG="log_ProMoE_B_repa_double_share_train_sample_eval.log"
