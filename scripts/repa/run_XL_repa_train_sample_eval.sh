#!/bin/bash
#
# Train ProMoE-TC-REPA-XL (naive REPA, encoder_depth=8), then sample and evaluate FID.
#
# Step 1: Train with configs/004_ProMoE_XL_repa.yaml
...
CONFIG="configs/004_ProMoE_XL_repa.yaml"
LOG="log_ProMoE_XL_repa_train_sample_eval.log"
