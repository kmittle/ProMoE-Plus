#!/bin/bash
#
# Train ProMoE-TC-REPA-Router-B, then sample and evaluate FID.
#
# Step 1: Train with configs/004_ProMoE_B_repa_router.yaml
...
CONFIG="configs/004_ProMoE_B_repa_router.yaml"
LOG="log_ProMoE_B_repa_router_train_sample_eval.log"
