#!/bin/bash
#
# ProMoE-TC-B EC mixing — series 2 (whole steps), 50% of steps are complete EC-BC steps.
...
CONFIG="configs/004_ProMoE_B_ecmix_step_p0p50.yaml"
LOG="${REPO_ROOT}/logs/log_ProMoE_B_ecmix_step_p0p50_train_sample_eval.log"
mkdir -p "$(dirname "$LOG")"
