#!/bin/bash
#
# ProMoE-TC-B EC mixing — series 1 (loss only), EC loss weight cosine-annealed 0.50 -> 0 at 500K.
...
CONFIG="configs/004_ProMoE_B_ecmix_loss_cos0p50.yaml"
LOG="${REPO_ROOT}/logs/log_ProMoE_B_ecmix_loss_cos0p50_train_sample_eval.log"
mkdir -p "$(dirname "$LOG")"
