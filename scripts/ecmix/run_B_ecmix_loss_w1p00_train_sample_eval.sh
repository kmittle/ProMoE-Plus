#!/bin/bash
#
# ProMoE-TC-B EC mixing — series 1 (loss only), EC contrastive-loss weight 1.00.
...
CONFIG="configs/004_ProMoE_B_ecmix_loss_w1p00.yaml"
LOG="${REPO_ROOT}/logs/log_ProMoE_B_ecmix_loss_w1p00_train_sample_eval.log"
mkdir -p "$(dirname "$LOG")"
