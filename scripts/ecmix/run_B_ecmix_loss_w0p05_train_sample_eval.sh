#!/bin/bash
#
# ProMoE-TC-B EC mixing — series 1 (loss only), EC contrastive-loss weight 0.05.
...
CONFIG="configs/004_ProMoE_B_ecmix_loss_w0p05.yaml"
LOG="${REPO_ROOT}/logs/log_ProMoE_B_ecmix_loss_w0p05_train_sample_eval.log"
mkdir -p "$(dirname "$LOG")"
