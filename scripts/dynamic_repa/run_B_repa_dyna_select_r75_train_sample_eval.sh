#!/bin/bash
#
# Train ProMoE-TC-REPA-DYNA-SELECT-B (select_ratio=0.75), then sample and evaluate FID.
#
# Step 1: Train with configs/004_ProMoE_B_repa_dyna_select_r75.yaml
...
CONFIG="configs/004_ProMoE_B_repa_dyna_select_r75.yaml"
LOG="log_ProMoE_B_repa_dyna_select_r75_train_sample_eval.log"
