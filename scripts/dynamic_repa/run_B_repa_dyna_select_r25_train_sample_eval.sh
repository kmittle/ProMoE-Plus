#!/bin/bash
#
# Train ProMoE-TC-REPA-DYNA-SELECT-B (select_ratio=0.25), then sample and evaluate FID.
#
# Step 1: Train with configs/004_ProMoE_B_repa_dyna_select_r25.yaml
...
CONFIG="configs/004_ProMoE_B_repa_dyna_select_r25.yaml"
LOG="log_ProMoE_B_repa_dyna_select_r25_train_sample_eval.log"
