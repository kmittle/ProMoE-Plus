#!/bin/bash
#
# Train ProMoE-TC-REPA-DYNA-SELECT-B, then sample and evaluate FID.
#
# Step 1: Train with configs/004_ProMoE_B_repa_dyna_select.yaml
...
CONFIG="configs/004_ProMoE_B_repa_dyna_select.yaml"
LOG="log_ProMoE_B_repa_dyna_select_train_sample_eval.log"
