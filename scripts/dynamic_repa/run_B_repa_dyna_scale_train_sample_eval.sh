#!/bin/bash
#
# Train ProMoE-TC-REPA-DYNA-SCALE-B, then sample and evaluate FID.
#
# Step 1: Train with configs/004_ProMoE_B_repa_dyna_scale.yaml
...
CONFIG="configs/004_ProMoE_B_repa_dyna_scale.yaml"
LOG="log_ProMoE_B_repa_dyna_scale_train_sample_eval.log"
