#!/bin/bash
#
# Train ProMoE-TC-B with noise expert, then sample and evaluate FID.
#
# The noise expert is an additional MoE expert (same size as shared expert)
# that receives noised tokens from clean images (sigma < 0.3) and is trained
# to align its output with the shared expert via negative cosine similarity.
#
# Step 1: Train with configs/004_ProMoE_B_noise_expert.yaml
...
CONFIG="configs/004_ProMoE_B_noise_expert.yaml"
LOG="log_ProMoE_B_noise_expert_train_sample_eval.log"
