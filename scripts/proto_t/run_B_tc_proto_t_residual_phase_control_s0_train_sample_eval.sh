...
CONFIG="configs/004_ProMoE_B_proto_t_residual_phase_control_s0.yaml"
LOG="${REPO_ROOT}/logs/log_ProMoE_B_proto_t_residual_phase_control_s0_train_sample_eval.log"
mkdir -p "$(dirname "$LOG")"
