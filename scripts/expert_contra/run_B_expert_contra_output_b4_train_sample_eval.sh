#!/bin/bash
#
# Train ProMoE-TC-B with expert output contrastive loss on block 4 only, then sample and evaluate FID.
#
...
#
# Step 1: Train with configs/004_ProMoE_B_expert_contra_output_b4.yaml
...
CONFIG="configs/004_ProMoE_B_expert_contra_output_b4.yaml"
LOG="log_ProMoE_B_expert_contra_output_b4_train_sample_eval.log"
