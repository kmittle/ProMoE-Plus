#!/bin/bash
#
# Train ProMoE-TC-B with expert parameter contrastive loss on block 4 only, then sample and evaluate FID.
#
# Adds parameter-based expert representation contrastive loss on top of routing
# contrastive loss, but only on the 4th MoE block (0-based index 3).
#
# Step 1: Train with configs/004_ProMoE_B_expert_contra_param_b4.yaml
...
CONFIG="configs/004_ProMoE_B_expert_contra_param_b4.yaml"
LOG="log_ProMoE_B_expert_contra_param_b4_train_sample_eval.log"
