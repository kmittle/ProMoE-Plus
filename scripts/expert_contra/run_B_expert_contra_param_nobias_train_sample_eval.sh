#!/bin/bash
#
# ProMoE-TC-B expert parameter contrastive — OFAT variant: drop Linear biases
# from the flattened expert parameter vector (vs _param baseline). Train +
# sample + eval, sequential template pipeline.
#
...
CONFIG="configs/004_ProMoE_B_expert_contra_param_nobias.yaml"
LOG="log_ProMoE_B_expert_contra_param_nobias_train_sample_eval.log"
