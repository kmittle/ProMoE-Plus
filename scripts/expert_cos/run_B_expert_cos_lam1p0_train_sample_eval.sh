...
# weight lam=1.0 (one arm of the 0.1 / 0.3 / 1.0 / 3.0 sweep).  Trains from
...
CONFIG="configs/004_ProMoE_B_expert_cos_lam1p0.yaml"
LOG="${REPO_ROOT}/logs/log_ProMoE_B_expert_cos_lam1p0_train_sample_eval.log"
mkdir -p "$(dirname "$LOG")"
