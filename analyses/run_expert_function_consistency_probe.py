"""Run the expert functional-transport responsibility probe."""
...
from analyses.expert_function import run_expert_function_consistency_probe
...
def _default_output_path(checkpoint_path, seed, block_index):
    ...
    return (
        ...
        / "sample"
        / f"step{step}"
        / "expert_function_consistency_probe"
...
def build_parser():
    parser = argparse.ArgumentParser(
        description=(
            "Test whether content-transported expert residual functions predict "
            "exact denoising responsibility."
        )
    )
