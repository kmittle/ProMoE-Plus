...
#################################################################################
#                              ProMoE_EC_BC Layer                                #
# Batch-Choice variant of ProMoE_EC: every expert picks its top-k tokens from    #
# the full batch-flattened pool of cond tokens (B_cond * S) instead of from      #
# each image independently. All other settings match ProMoE_EC exactly.          #
#################################################################################
